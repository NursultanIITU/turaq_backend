...
use App\Filament\Resources\Ads\TariffTypeResource\Pages;
...
class TariffTypeResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListTariffTypes::route('/'),
            'create' => Pages\CreateTariffType::route('/create'),
            'edit' => Pages\EditTariffType::route('/{record}/edit'),
        ];
    }

    public static function getLabel(): ?string
    {
        return __('tariff_type.resource.label');
    }

    public static function getPluralLabel(): ?string
    {
        return __('tariff_type.resource.plural_label');
    }
